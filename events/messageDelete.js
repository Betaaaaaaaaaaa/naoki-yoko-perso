...
module.exports = {
    ...
    async execute(client, message) {
        ...
        const embed1 = new Discord.MessageEmbed()
            ...
            .setDescription(`Message supprimé de <@${message.author.id}> dans [\`${message.channel.name}\`](https://discord.com/channels/${message.guild.id}/${message.channel.id}) par <@${executor.id}>\n\`${mess}\``)
