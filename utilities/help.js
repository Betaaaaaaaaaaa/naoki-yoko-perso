...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (img == null) img = "https://cdn.discordapp.com/attachments/904084986536276059/1004761067114737694/standard_10.gif"
        ...
        if (args[0] === "all") {
            ...
            const help = new Discord.MessageEmbed()
                ...
                .setDescription(`<a:money:957097905276203068>・Ce bot appartient à <@${config.app.owners}>`)
                .setImage(imgperm)
                .setColor(color)
